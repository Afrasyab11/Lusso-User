...
const AddAppTab: React.FC<AddAppTabProps> = ({ setCurrentStep, currentStep, countries, getAllProducts }) => {
    // ------------------------ Handle Submission ------------------------
    ...
    const handleSubmission = () => {
        ...
        if (!hasError) {
            context?.setProductInfo({ productInfo, fields });
    ...
    // const sourceOptions = ["G-Drive", "Apple Store", "Netflix", "Play Store"];
    const sourceOptions = [
        "Play Store",
        "APP Store",
        "Netflix",
    ...
    const plansOptions = ["Buy now", "Subscription", "Annually", "Monthly", "Free"];
                        ...
                        <div className="md-lt:pl-0 md-lt:pt-2 lg:pl-2 flex flex-col gap-3 w-full">
                            ...
                            >
                                <PhoneInput
                                    ...
                                    inputClass="appearance-none bg-transparent placeholder-gray-400 leading-tight focus:outline-none"
                                />
                            </div>
                        </div>
                    </div>
                                    ...
                                    {ageRestrictions?.map((restriction, index) => (
                                        ...
                                        >
                                            <div
                                                ...
                                                onClick={() => removeAgeRestriction(index)}
                                            >
                                                <GrFormClose />
                                            </div>
