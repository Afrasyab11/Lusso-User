...
import banner from '../../assets/images/home/about-us-banner.svg';
...
export const ExploreButton: React.FC<ExploreButtonProps> = ({ onClick, title = null }) => (
    <button
        onClick={onClick}
        className="explorebtn text-white uppercase px-6 py-2 rounded-full transition-colors duration-300 flex items-center"
    >
        {title ? title : 'EXPLORE NOW'}
        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" className='ml-2'>
...
const HeroSection: any = ({ isLogged = false }) => {
    ...
    return (
        <div className="relative md-lt:h-[40vh] md:h-[70vh] fhd:h-[50vh] w-full bg-cover bg-center flex justify-center items-end pb-14  responsive-banner" style={{ backgroundImage: `url(${banner})` }}>
            <div className="absolute inset-0 bg-gradient-to-r opacity-75"></div>
            <div className="relative bottom-5 md-lt:bottom-16 z-10 text-center text-white px-4">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
                    BUILDING THE WORLD'S MOST
                </h1>
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                    <span className="text-[#00F0FB]">INNOVATIVE DIGITAL MARKETPLACE</span>
                </h2>
                <p className='flex flex-col items-center w-full gap-4 mt-5'>
                    ...
                    {/* <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                        ...
                        <path d="M8.75 7.5L15 13.75L21.25 7.5" stroke="#5A5A5A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg> */}
                </p>
            </div>
        </div>
