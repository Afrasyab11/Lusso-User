        ...
        <div className='mt-6'>
            ...
            <div className="followers-section p-4 border border-blue-400 rounded-md space-y-3 w-full md:w-1/2">
                <div className="flex flex-col md:flex-row justify-between md:items-center space-y-2">
                    <span className="text-lg font-bold">Impressions</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-6 border border-blue-400 rounded-md">
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                        <LineChart data={data}>
                            ...
                            <CartesianGrid
                                ...
                                strokeDasharray="none" // Make the horizontal grid lines solid
                            />
                            <XAxis dataKey="date" />
                            <YAxis domain={[0, 5000]} ticks={[1000, 2000, 3000, 4000, 5000]} />
                            <Tooltip />

                            {/* Different colored lines for each social media */}
                            <Line
                                type="monotone"
                                dataKey="youtube"
                                stroke="red"
