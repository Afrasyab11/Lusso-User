...
const Header = ({ headerData, handleUserAction, product, isCreator = false }: any) => {
    ...
    return (
        <div className="flex items-center mb-8 gap-5 flex-col md:flex-row">
            ...
            <div className='flex flex-col items-center md:items-start justify-between gap-3'>
                <h1 className="text-2xl md:text-4xl font-bold text-center md:text-start">{headerData?.title}</h1>
