...
function AvailableAt({ selectedOption, setSelectedOption, sourceLinks }: any) {
    let png = {
        ...
        "Apple Store": "https://lusso-marketplace-dev.s3.us-east-2.amazonaws.com/products/mediaplatform/app+store.png",
    ...
    return (
        <div className="mb-3 bg-[#161328] rounded-2xl p-5">
            ...
            {platformInfo?.length > 0 ? platformInfo.map((platform: any, index: any) => (
                <div key={index} className="bg-[#111924] p-4 shadow-md border-2 border-[#a145e7]
                    md:border-0 rounded-[16px] md:rounded-0 mb-4 md:mb-0">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-3 md:gap-0 py-5">
                        ...
                        <div className="md:w-2/6 flex items-center justify-end">
                            <button
                                className="text-white px-5 py-2 rounded-full text-sm flex items-center border-[#7D3CF3] border-2 font-medium 
                                transition duration-300 ease-in-out 
                                hover:bg-[#7D3CF3] hover:text-black hover:shadow-lg"
