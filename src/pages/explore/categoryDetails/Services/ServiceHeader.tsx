...
const ServiceHeader = ({ headerData, handleContactAction, handleUserAction, product, onAppointmentBook }: any) => {
        ...
        <div className="flex items-center mb-8 gap-5 flex-col md:flex-row">
            ...
            <div className='flex flex-col items-center md:items-start justify-between gap-3'>
                ...
                <div className="flex flex-col gap-3">
                    <div className='flex flex-col items-center md:items-start'>
                        <p className='text-[#6DDCFF] font-semibold'>Service by</p>
                ...
                <div>
                    <button type='button' onClick={onAppointmentBook} className='bg-[#5721B9] text-white font-medium text-md flex gap-1 py-2 px-4 rounded-3xl'>
                        Book appointment
